...
import org.cliente.api.v1.controller.ProdutoController;
...
@QuarkusTest
@TestHTTPEndpoint(ProdutoController.class)
class ProdutoControllerTest {
    ...
    void salva_produto() throws IOException {
        given()
                .contentType(ContentType.JSON)
                .body(FileUtils.readFileData("produto/produto_request.json"))
                .when()
                .post()
                .then()
                .statusCode(HttpStatus.SC_OK)
                .body("descricao", equalTo("Cano longo 2"));
    }
